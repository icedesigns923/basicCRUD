	...
	<div class="col-md-6 col-md-offset-3">
		<div class="box">
			...
			<form action="" method="POST">
				...
				<input type="text" id="courseid"  name="courseid" value="<?php echo $row['courseid']; ?>" class="form-control"><br>
				<label for="coursename">Course Name </label>
				<input type="text"  name="coursename" id="coursename" value="<?php echo $row['coursename']; ?>" class="form-control"><br>
				<br>
